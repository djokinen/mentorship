...
[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="cree_membership")]
public partial class DataClassesDataContext : System.Data.Linq.DataContext
{
  ...
  partial void Insertcree_MentorIndustry(cree_MentorIndustry instance);
  partial void Updatecree_MentorIndustry(cree_MentorIndustry instance);
  partial void Deletecree_MentorIndustry(cree_MentorIndustry instance);
  ...
  partial void Insertcree_Industry(cree_Industry instance);
  partial void Updatecree_Industry(cree_Industry instance);
  partial void Deletecree_Industry(cree_Industry instance);
  partial void Insertcree_MenteeMentor(cree_MenteeMentor instance);
  partial void Updatecree_MenteeMentor(cree_MenteeMentor instance);
  partial void Deletecree_MenteeMentor(cree_MenteeMentor instance);
  #endregion
	
	public DataClassesDataContext() : 
			base(global::System.Configuration.ConfigurationManager.ConnectionStrings["CreeConnectionString"].ConnectionString, mappingSource)
	{
		OnCreated();
	}
	...
	public System.Data.Linq.Table<cree_MentorIndustry> cree_MentorIndustries
	{
		get
		{
			return this.GetTable<cree_MentorIndustry>();
		}
	}
	...
	public System.Data.Linq.Table<cree_Industry> cree_Industries
	{
		get
		{
			return this.GetTable<cree_Industry>();
		}
	}
	
	public System.Data.Linq.Table<cree_MenteeMentor> cree_MenteeMentors
	{
		get
		{
			return this.GetTable<cree_MenteeMentor>();
		}
	}
}
...
[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.cree_MentorIndustry")]
public partial class cree_MentorIndustry : INotifyPropertyChanging, INotifyPropertyChanged
{
	
	private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
	
	private System.Guid _UserIdMentor;
	...
	private EntityRef<cree_Industry> _cree_Industry;
	
    #region Extensibility Method Definitions
    partial void OnLoaded();
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnUserIdMentorChanging(System.Guid value);
    partial void OnUserIdMentorChanged();
	...
	public cree_MentorIndustry()
	{
		this._aspnet_User = default(EntityRef<aspnet_User>);
		this._cree_Industry = default(EntityRef<cree_Industry>);
		OnCreated();
	}
	
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_UserIdMentor", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
	public System.Guid UserIdMentor
	{
		get
		{
			return this._UserIdMentor;
		}
		set
		{
			if ((this._UserIdMentor != value))
			{
				if (this._aspnet_User.HasLoadedOrAssignedValue)
				{
					throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
				}
				this.OnUserIdMentorChanging(value);
				this.SendPropertyChanging();
				this._UserIdMentor = value;
				this.SendPropertyChanged("UserIdMentor");
				this.OnUserIdMentorChanged();
			}
		}
	}
	...
	public int IndustryId
	{
		...
		set
		{
			...
			{
				if (this._cree_Industry.HasLoadedOrAssignedValue)
				{
					throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
				}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_cree_MentorIndustry", Storage="_aspnet_User", ThisKey="UserIdMentor", OtherKey="UserId", IsForeignKey=true)]
		...
		set
		{
						...
						|| (this._aspnet_User.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.cree_MentorIndustries.Remove(this);
				}
				this._aspnet_User.Entity = value;
				if ((value != null))
				{
					value.cree_MentorIndustries.Add(this);
					this._UserIdMentor = value.UserId;
				}
				else
				{
					this._UserIdMentor = default(System.Guid);
				}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="cree_Industry_cree_MentorIndustry", Storage="_cree_Industry", ThisKey="IndustryId", OtherKey="ID", IsForeignKey=true)]
	public cree_Industry cree_Industry
	{
		get
		{
			return this._cree_Industry.Entity;
		}
		set
		{
			cree_Industry previousValue = this._cree_Industry.Entity;
			if (((previousValue != value) 
						|| (this._cree_Industry.HasLoadedOrAssignedValue == false)))
			{
				this.SendPropertyChanging();
				if ((previousValue != null))
				{
					this._cree_Industry.Entity = null;
					previousValue.cree_MentorIndustries.Remove(this);
				}
				this._cree_Industry.Entity = value;
				if ((value != null))
				{
					value.cree_MentorIndustries.Add(this);
				...
				{
					this._IndustryId = default(int);
				}
				this.SendPropertyChanged("cree_Industry");
			}
		}
	}
...
public partial class aspnet_User : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<cree_MentorIndustry> _cree_MentorIndustries;
	...
	private EntitySet<cree_MenteeMentor> _cree_MenteeMentors;
	
	private EntitySet<cree_MenteeMentor> _cree_MenteeMentors1;
	...
	public aspnet_User()
	{
		this._cree_MentorIndustries = new EntitySet<cree_MentorIndustry>(new Action<cree_MentorIndustry>(this.attach_cree_MentorIndustries), new Action<cree_MentorIndustry>(this.detach_cree_MentorIndustries));
		this._aspnet_Membership = default(EntityRef<aspnet_Membership>);
		this._aspnet_PersonalizationPerUsers = new EntitySet<aspnet_PersonalizationPerUser>(new Action<aspnet_PersonalizationPerUser>(this.attach_aspnet_PersonalizationPerUsers), new Action<aspnet_PersonalizationPerUser>(this.detach_aspnet_PersonalizationPerUsers));
		this._aspnet_Profile = default(EntityRef<aspnet_Profile>);
		this._aspnet_UsersInRoles = new EntitySet<aspnet_UsersInRole>(new Action<aspnet_UsersInRole>(this.attach_aspnet_UsersInRoles), new Action<aspnet_UsersInRole>(this.detach_aspnet_UsersInRoles));
		this._cree_MenteeMentors = new EntitySet<cree_MenteeMentor>(new Action<cree_MenteeMentor>(this.attach_cree_MenteeMentors), new Action<cree_MenteeMentor>(this.detach_cree_MenteeMentors));
		this._cree_MenteeMentors1 = new EntitySet<cree_MenteeMentor>(new Action<cree_MenteeMentor>(this.attach_cree_MenteeMentors1), new Action<cree_MenteeMentor>(this.detach_cree_MenteeMentors1));
		this._aspnet_Application = default(EntityRef<aspnet_Application>);
		OnCreated();
	}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_cree_MentorIndustry", Storage="_cree_MentorIndustries", ThisKey="UserId", OtherKey="UserIdMentor")]
	public EntitySet<cree_MentorIndustry> cree_MentorIndustries
	{
		get
		{
			return this._cree_MentorIndustries;
		}
		set
		{
			this._cree_MentorIndustries.Assign(value);
		}
	}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_cree_MenteeMentor", Storage="_cree_MenteeMentors", ThisKey="UserId", OtherKey="UserIdMentee")]
	public EntitySet<cree_MenteeMentor> cree_MenteeMentors
	{
		get
		{
			return this._cree_MenteeMentors;
		}
		set
		{
			this._cree_MenteeMentors.Assign(value);
		}
	}
	
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_cree_MenteeMentor1", Storage="_cree_MenteeMentors1", ThisKey="UserId", OtherKey="UserIdMentor")]
	public EntitySet<cree_MenteeMentor> cree_MenteeMentors1
	{
		get
		{
			return this._cree_MenteeMentors1;
		}
		set
		{
			this._cree_MenteeMentors1.Assign(value);
		}
	}
	...
	private void attach_cree_MentorIndustries(cree_MentorIndustry entity)
	{
		this.SendPropertyChanging();
		entity.aspnet_User = this;
	}
	
	private void detach_cree_MentorIndustries(cree_MentorIndustry entity)
	{
		this.SendPropertyChanging();
	...
	private void attach_cree_MenteeMentors(cree_MenteeMentor entity)
	{
		this.SendPropertyChanging();
		entity.aspnet_User = this;
	}
	
	private void detach_cree_MenteeMentors(cree_MenteeMentor entity)
	{
		this.SendPropertyChanging();
		entity.aspnet_User = null;
	}
	
	private void attach_cree_MenteeMentors1(cree_MenteeMentor entity)
	{
		this.SendPropertyChanging();
		entity.aspnet_User1 = this;
	}
	
	private void detach_cree_MenteeMentors1(cree_MenteeMentor entity)
	{
		this.SendPropertyChanging();
...
[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.cree_Industry")]
public partial class cree_Industry : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="cree_Industry_cree_MentorIndustry", Storage="_cree_MentorIndustries", ThisKey="ID", OtherKey="IndustryId")]
	public EntitySet<cree_MentorIndustry> cree_MentorIndustries
	{
		get
		{
	...
	{
		this.SendPropertyChanging();
		entity.cree_Industry = this;
	}
	
	private void detach_cree_MentorIndustries(cree_MentorIndustry entity)
	{
		this.SendPropertyChanging();
		entity.cree_Industry = null;
	}
}

[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.cree_MenteeMentor")]
public partial class cree_MenteeMentor : INotifyPropertyChanging, INotifyPropertyChanged
{
	
	private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
	
	private System.Guid _UserIdMentee;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnUserIdMenteeChanging(System.Guid value);
    partial void OnUserIdMenteeChanged();
    partial void OnUserIdMentorChanging(System.Guid value);
    partial void OnUserIdMentorChanged();
    partial void OnCreatedDateChanging(System.DateTime value);
    partial void OnCreatedDateChanged();
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_UserIdMentee", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
	public System.Guid UserIdMentee
	{
		get
		{
			return this._UserIdMentee;
		}
		set
		{
			if ((this._UserIdMentee != value))
			{
				if (this._aspnet_User.HasLoadedOrAssignedValue)
				{
					throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
				}
				this.OnUserIdMenteeChanging(value);
				this.SendPropertyChanging();
				this._UserIdMentee = value;
				this.SendPropertyChanged("UserIdMentee");
				this.OnUserIdMenteeChanged();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_cree_MenteeMentor", Storage="_aspnet_User", ThisKey="UserIdMentee", OtherKey="UserId", IsForeignKey=true)]
	public aspnet_User aspnet_User
	{
		get
		{
		...
		set
		{
						...
						|| (this._aspnet_User.HasLoadedOrAssignedValue == false)))
			{
				...
				{
					this._aspnet_User.Entity = null;
					previousValue.cree_MenteeMentors.Remove(this);
				}
				this._aspnet_User.Entity = value;
				if ((value != null))
				{
					value.cree_MenteeMentors.Add(this);
					this._UserIdMentee = value.UserId;
				}
				else
				{
					this._UserIdMentee = default(System.Guid);
				}
				this.SendPropertyChanged("aspnet_User");
			}
		}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_cree_MenteeMentor1", Storage="_aspnet_User1", ThisKey="UserIdMentor", OtherKey="UserId", IsForeignKey=true)]
		...
		set
		{
						...
						|| (this._aspnet_User1.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.cree_MenteeMentors1.Remove(this);
				}
				this._aspnet_User1.Entity = value;
				if ((value != null))
				{
					value.cree_MenteeMentors1.Add(this);
					this._UserIdMentor = value.UserId;
				}
				else
				{
